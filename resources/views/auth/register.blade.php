                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" id="hic" name="HIC_id" required>
                                        ...
                                        <option value="4" {{ old('HIC_id') == 3 ? 'selected' : '' }}>Nat Health Company (شركة نات هيلث)</option>
                                        <option value="5" {{ old('HIC_id') == 3 ? 'selected' : '' }}>GIG (شركة الشرق العربي)</option>
                                        <option value="6" {{ old('HIC_id') == 3 ? 'selected' : '' }}>Med Service (شركة ميد سيرفس)</option>
                                        <option value="7" {{ old('HIC_id') == 3 ? 'selected' : '' }}>Al-Nisr Al-Arabi Insurance(شركة النسر العربي)</option>
                                        <option value="9" {{ old('HIC_id') == 3 ? 'selected' : '' }}>ACT (محطة حاويات العقبة)</option>
                                    </select>
                                    @error('HIC_id')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
